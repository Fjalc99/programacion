...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Set <Trastero> lista = new HashSet <> ();
		...
		do {
			...
			switch(opcion) {
				...
				case 3:
						...
						System.out.println(of.buscarPorNumero(numeroTrastero));
				...
				case 4:
					...
					System.out.println(of.buscarPrecioMayor());
				...
				case 5:
					...
					of.eliminarTrastero(numeroTrastero);
				...
				case 6:
					...
					of.modificarPrecio(of.buscarPorNumero(numeroTrastero), nuevoPrecio);
					
				case 7:
					
					of.mostrarNoOcupados();
					break;
